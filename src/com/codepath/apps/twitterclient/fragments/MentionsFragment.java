...
public class MentionsFragment extends TweetsListFragment {
	...
	public void fetchBaseTweets() {
		TwitterClientApp.getRestClient().getMentionsTimeline(addOlderTweetsHandler, null);
	}

	// This method loads older tweets from the bottom of the feed
	@Override
	public void loadOlderTweets() {
		TwitterClientApp.getRestClient().getMentionsTimeline(addOlderTweetsHandler, maxId);
	}

	// This method loads newer tweets from the top of the feed
	@Override
	public void loadNewTweets() {
		TwitterClientApp.getRestClient().getMentionsTimelineSince(addNewerTweetsHandler, sinceId);
	}
}
